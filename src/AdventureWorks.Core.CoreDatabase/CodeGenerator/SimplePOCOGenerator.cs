//This file is supposed to be launched using: codegencs run SimplePOCOGenerator.cs
using CodegenCS;
...
class Program
{
    static void Main()
    {
        Environment.CurrentDirectory = @"C:\Repositories\Harbin\src\AdventureWorks.Core.CoreDatabase\CodeGenerator\";
        //var options = new CodegenCS.DbSchema.Templates.SimplePOCOGenerator.SimplePOCOGeneratorOptions(inputJsonSchema: @"AdventureWorks.json");
        var options = Newtonsoft.Json.JsonConvert.DeserializeObject<CodegenCS.DbSchema.Templates.SimplePOCOGenerator.SimplePOCOGeneratorOptions>(@"
            {
              ""InputJsonSchema"": ""..\\CoreDbSchema.json"",
              ""TargetFolder"": ""..\\..\\AdventureWorks.Core.Domain\\Entities\\"",
              ""POCOsNamespace"": ""AdventureWorks.Core.Domain.Entities"",
              ""GenerateEqualsHashCode"": true,
              ""TrackPropertiesChange"": false,
              ""AddColumnAttributeKey"": true,
              ""AddColumnAttributeDatabaseGenerated"": true,
              ""CRUDClassMethodsSettings"": {
                ""CrudClassNamespace"": ""AdventureWorks.Core.CoreDatabase"",
                ""CrudClassFile"": ""..\\..\\AdventureWorks.Core.CoreDatabase\\CoreDbReadWriteConnection.CRUD.generated.cs"",
                ""CrudClassName"": ""CoreDbReadWriteConnection""
              }
            }
        ");
        var generator = new CodegenCS.DbSchema.Templates.SimplePOCOGenerator.SimplePOCOGenerator(options);
